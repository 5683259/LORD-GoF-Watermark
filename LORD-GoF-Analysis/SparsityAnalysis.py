...
def run_experiment(exp_cfg, idx):
    ...
    for m in methods:
        ...
        plt.plot(results[m]['pi'], results[m]['fdr'], label=m, linestyle=ls, color=col, alpha=alpha, marker='o',
                 markersize=3)
    ...
    for m in methods:
        ...
        col = colors[tname]
        alpha = 1.0 if prefix == 'LORD' else 0.6
        plt.plot(results[m]['pi'], results[m]['pow'], label=m, linestyle=ls, color=col, alpha=alpha, marker='o',
                 markersize=3)
